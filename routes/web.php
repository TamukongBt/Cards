...
| routes pare loaded by the RouteServiceProvider within a group which
...
Route::group(['middleware' => ['auth']], function () {
    Route::group(['middleware' => 'isActive'], function () {
        ...
        // Custom Views
        Route::get('/inactive', 'UserController@inactive')->name('users.inactive');
        ...
        Route::get('/user_ajax', 'UserController@index1');
        ...
        Route::get('/inactive_ajax', 'UserController@inactive1');
        Route::get('/updote', 'UserController@adonis');
        ...
        Route::post('user/role/{id}', 'UserController@change');
