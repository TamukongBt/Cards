@extends('layouts.app', [
'class' => '',
'elementActive' => 'cardapproves'
])

@section('title')
Approved Request by Branch Administrator Or Sales Manager
@endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Approved Request by Branch Administrator Or Sales Agent</h4>
