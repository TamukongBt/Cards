                                ...
                                <tbody>
                                 @foreach ($request as $entry)
                                    ...
                                    <tr>
                                        ...
                                        @auth
                                        @can('validate')
                                        <td><a class="btn btn-outline-primary btn-sm" href="/request/fulfilled/{{ $entry->id }}"><i class="nc-icon nc-check-2"
                                        aria-hidden="true" style="color: black"></i></a></td>
                                        @endcan
                                        @can('edit')
                                        <td id="float">
                                        <button  id="view" type="button" class="btn btn-outline-dark btn-sm" data-toggle="modal"
                                                data-target="#viewmodal" style="cursor:pointer;">
                                            <i class="nc-icon nc-simple-info" aria-hidden="true" style="color: black"></i>
                                        </button>
                                        ...
                                        <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered " role="document">
                                                <div class="modal-content">
                                                    <div class="card-header" >
                                                    <h5 class="modal-title" id="exampleModalLongTitle"><span id="accountname_title"></span> <a href="{{ route('request.edit',$entry->id)}}"  ><i class="fa fa-pencil text-dark" aria-hidden="true"></i></a></h5>
                                        ...
                                        <td>
                                            <button id="deletebutton" type="button" class="btn btn-outline-dark btn-sm" data-toggle="modal"
                                            data-target="#delete" style="cursor:pointer;" >
                                                <i class="nc-icon nc-simple-remove" aria-hidden="true" style="color: black"></i>
                                            </button>
